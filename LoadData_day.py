...
conn = MySQLdb.connect(host='127.0.0.1',user='root',passwd='123456',port=3306,db='test1')
cursor = conn.cursor()
...
while 1:
    ...
    try:
        ...
        #load csv table
        sql_load = "LOAD DATA INFILE 'C:\\\\Users\\\\Administrator\\\\Desktop\\\\160801-160831sh\\\\160801-160831t\\\\"+code+".SH"+".csv"+"'"+\
